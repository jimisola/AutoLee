...
static void IRAM_ATTR touch_isr(void *) { s_int_flag = true; }
...
void axs5106l_touch_init(i2c_master_bus_handle_t i2c_bus, gpio_num_t rst_gpio,
    ...
    gpio_install_isr_service(0); // ok if already installed elsewhere: returns ESP_ERR_INVALID_STATE, ignored
